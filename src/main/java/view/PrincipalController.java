...
public class PrincipalController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        mesEmpresa = new MesEmpresa("2018", "05",empresa, 28, 527.25, 7.89);
        ...
        mesesRepository.save(meses);
        mesEmpresa = new MesEmpresa("2018", "05",empresa, 58, 1277.25, 28.38);
        mesEmpresaRepository.save(mesEmpresa);
        ...
        mesesRepository.save(meses);
        mesEmpresa = new MesEmpresa("2018", "05",empresa, 22, 685.25, 9.89);
        mesEmpresaRepository.save(mesEmpresa);
        ...
        mesesRepository.save(meses);
        mesEmpresa = new MesEmpresa("2018", "05",empresa, 78, 1357.25, 32.38);
        mesEmpresaRepository.save(mesEmpresa);
    }    
}
